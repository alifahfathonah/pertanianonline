 <!-- Main content -->
	 <div class="main-content">
			 <h1 class="page-title"><center>DATA BARANG</center> </h1>
			 <hr> 
			<!-- Breadcrumb -->
			...
			<a href="admin/tambah_data_barang" class="btn btn-success  btn-rounded">TAMBAH DATA</a>
								...
								<table class="table table-striped table-bordered table-hover dataTables-example" >
									...
									<tbody>
										<tr class="gradeX">
											...
											<td>
												<a href="admin/edit_barang/<?php echo $value->id_barang ?>" class='btn btn-blue  btn-rounded'>EDIT</a>
												<a href="admin/hapus_barang/<?php echo $value->id_barang ?>" class='btn btn-secondary  btn-rounded'>HAPUS</a>
											</td>
										</tr>
