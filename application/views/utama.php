...
<div class="content_top"> 
	<div class="container"> 
		<div class="grid_1"> 
			<div class="col-md-3"> 
			 <div class="box2"> 
			 	<ul class="list1"> 
			 		<i class="lock"> </i> 
			 		<li class="list1_right"><p>Bisa Order Hasil Pertanian anda </p></li> 
		...
		<div class="column_center"> 
			<h1>PERTANIAN ONLINE </h1> 
			<h2>Situs jual beli hasil pertanian NO 1 terjamin dan berkualitas</h2> 
		</div> 
		<div class="sellers_grid"> 
			<ul class="sellers"> 
				<i class="star"> </i> 
				<li class="sellers_desc"><h2>Daftar Hasil Pertanian Baru</h2></li> 
				<div class="clearfix"> </div> 
			</ul> 
		</div> 
	<div class="grid_2"> 
...
<?php       
				 ...
				 <div class="desc"> 
				 	...
				 	<h4><?php echo $row->harga ?></h4> 
				 	<ul class="list2"> 
				 	  <li class="list2_right"><span class="m_2"><a href="index.php/web/detail_barang/<?php echo $row->id_barang ?>" class="link1">Pesan</a></span></li> 
				 	  <div class="clearfix"> </div> 
				 	</ul> 
				 	<div class="heart"> </div> 
				 </div> 
